...
void solve(const char *__s, std::string symmetric){
...
// TRY CHOLESKY DECOMPOSITION
    ...
    if ((chol_success == false && symmetric.compare("symmetric") == 0) || symmetric.compare("non_symmetric") == 0) {
...
int main(){
    ...
    solve("GT01R.mtx", "non_symmetric");
    //solve("TSC_OPF_1047.mtx", "symmetric");
    //solve("ns3Da.mtx", "non_symmetric");
    //solve("bundle_adj.mtx", "symmetric");
    //solve("ifiss_mat.mtx", "non_symmetric");
    //solve("G3_circuit.mtx", "symmetric");
    //solve("nd24k.mtx", "symmetric");
    //solve("Hook_1498.mtx", "symmetric");
}
